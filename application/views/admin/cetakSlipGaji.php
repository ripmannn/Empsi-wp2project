        ...
        <?php foreach ($print_slip as $ps): ?>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center">Rp.
                        <?= number_format($ps->tj_transport, 0, ',', '.') ?>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <th class="text-center">Rp.
                        <?= number_format($ps->gaji_pokok + $ps->tj_transport + $ps->uang_makan - $potongan_gaji, 0, ',', '.') ?>
                        </td>
                </tr>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="230px">
                        <p>Jakarta,
                            <?= date("d M Y") ?> <br> Manager Operational,
                        </p>
                        <br>
                        <br>
